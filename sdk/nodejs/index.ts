...
pulumi.runtime.registerResourceModule("spotify", "index", _module)
pulumi.runtime.registerResourcePackage("spotify", {
    version: utilities.getVersion(),
    constructProvider: (name: string, type: string, urn: string): pulumi.ProviderResource => {
        if (type !== "pulumi:providers:spotify") {

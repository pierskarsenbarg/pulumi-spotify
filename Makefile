PROJECT_NAME := Pulumi Spotify Resource Provider

PACK             := spotify
PACKDIR          := sdk
PROJECT          := github.com/pierskarsenbarg/pulumi-spotify
NODE_MODULE_NAME := @pierskarsenbarg/spotify
NUGET_PKG_NAME   := PiersKarsenbarg.Spotify
